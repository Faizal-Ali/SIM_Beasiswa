<?php
    ...
    if(!empty($_POST['username']) && !empty($_POST['password'])){
        $query = "select * from tb_mahasiswa where username like '".$_POST['username']."' and password like '".$_POST['password']."'";
        echo $query;
        ...
        if(!empty($data['ID'])){
            $_SESSION['data-mahasiswa'] = $data;
        }
    }

    if(!empty($_SESSION['data-mahasiswa'])){
